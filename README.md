...
<details>
<summary><b>출석체크 및 이벤트</b></summary>
<div markdown="1"><br/>
<img src="https://github.com/user-attachments/assets/cfbd5829-a245-4f64-889b-13dded28c67e" width="800">

- 출석체크, 룰렛으로 리워드를 얻게 됩니다.

<img width="800" alt="image" src="https://github.com/user-attachments/assets/2311a968-55d9-4e4f-aa4f-8e8cf79c65ff">

- 금융지식과 관련된 퀴즈를 풀며 리워드를 얻게 됩니다.
...
<details>
<summary><b>모의투자</b></summary>
<div markdown="1"><br/>
<img width="800" alt="image" src="https://github.com/user-attachments/assets/0f1f4d95-5718-4ad4-83dc-f54b4e3554f4">

- KOSPI, KOSDAQ 종목 검색할 수 있으며 매수하는 화면입니다.

<img width="800" alt="image" src="https://github.com/user-attachments/assets/5dc45fec-8a12-4c44-9462-13ae6826d2c4">

- 사용자가 매수한 전체 주식을 수익률과 함께 볼 수 있습니다.

<img width="800" alt="image" src="https://github.com/user-attachments/assets/2f7aaebd-969e-488e-a0f1-85d18da4bc9f">
...
<details>
<summary><b>모구리 상점</b></summary>
<div markdown="1"><br/>
<img width="800" alt="image" src="https://github.com/user-attachments/assets/fc2e5e0b-9aac-4092-9f8f-046379b1f065">


- 사용자는 모아둔 리워드로 모구리 캐릭터를 구매하여 프로필에 사용 가능합니다.
...
| [오상민<br>(BE Leader)](https://github.com/AsthuX) | [이혁](https://github.com/) | [정유리](https://github.com/owzl) | [신동민] | [백승은] | [이은지] |
| :---: | :---: | :---: | :---: | :---: | :---: | 
...
| - 모의투자 백엔드 구현<br>- 주식정보 Redis 캐싱 구현<br>- 모의투자 랭킹 백엔드 구현<br>- 랭킹 서비스 스케줄러 구현<br>- 모구리 상점 백엔드 구현<br>- 공통 응답 포맷, 커스텀 에러 구현 | - 로그인 및 회원가입 구현<br>| - 가계부 백엔드 구현<br> - 퀘스트 백엔드 구현<br> - 모구리 상점 프론트엔드 구현| - 퀴즈 구현<br>- 룰렛 구현 | - 모의투자 프론트 구현<br>- 모의투자 랭킹 프론트 구현<br> | - 모구리 소개 페이지 프론트 구현<br> |
